	...
	if ($POSICION=="AMBIENTE"){
		...
		echo "
                ...
                <div class=\"info-box-content\">
                    <span class=\"info-box-text\" onclick=\"$('#cuerpo').load('pages_informes/tempcuba1.php?DEVICE=$DEVICE&RASPBERRY=$RASPBERRY');\"><a href=\"#inf_tempamb\"><i class=\"fa fa-info-circle\"></i> Cuba $DEVICE</a></span>
