...
$campos_busqueda = array("Descripción"=>"descripcionInput");
...
<div class="col-md-11">
	...
	?>
		...
		<a onclick="$('#cuerpo').load('pages_admin/input_crear.php');" href="#input_crear" role="button" class="btn btn-sm btn-success pull-right"><span class="glyphicon glyphicon-plus-sign"></span> Agregar</a>

	<h4>Inputs registrados en el sistema</h4>

	<?php
	$_GET['select'] = "Pagina_idPagina as Pagina, nombreInput as Nombre, descripcionInput as Descripcion, activoInput as Estado";
	$_GET['orderby'] = "activoInput DESC, Pagina_idPagina DESC, nombreInput";
	$_GET['tabla']['width'] = "25%, 25%, 25%, 15%";
	$_GET['tabla']['title'] = "Página, Nombre, Descripción, Estado";
	$_GET['acciones'] = "true";
	$_GET['accion']['editar']['URL'] = "pages_admin/input_editar.php";
	$_GET['accion']['editar']['title'] = "Editar";
	$_GET['accion']['editar']['class'] = "glyphicon glyphicon-pencil";
	$_GET['accion']['activar']['URL'] = "pages_admin/input_estado.php";
